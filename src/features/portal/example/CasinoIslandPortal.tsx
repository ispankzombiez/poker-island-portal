...
import { CasinoIslandPhaser } from "./CasinoIslandPhaser";
...
/**
 * Casino Island Portal - loads the Casino Island minigame
 */
export const CasinoIslandPortal: React.FC = () => {
